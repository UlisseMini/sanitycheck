...
(() => {
  ...
  (function() {
    ...
    const USE_CSS_HIGHLIGHT_API = typeof CSS !== "undefined" && typeof CSS.highlights !== "undefined" && typeof Highlight !== "undefined";
    ...
    function handleMouseMoveForHighlight(e) {
      ...
      if (data) {
        if (data !== lastHighlightData) {
          ...
          const tooltip2 = ensureTooltip();
          positionTooltip(e, tooltip2);
        }
      } else {
    ...
    function showTooltipForData(e, data) {
      ...
      tooltip2.className = `logic-checker-tooltip ${importance}`;
    ...
    function positionTooltip(e, tooltipElement) {
      const tooltip2 = tooltipElement || ensureTooltip();
      const padding = 15;
      ...
      tooltip2.style.left = `${Math.max(padding, x)}px`;
      tooltip2.style.top = `${Math.max(padding, y)}px`;
    }
